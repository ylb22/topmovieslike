...
import { getMovie, getCastDetails } from "../../servies/movieSlice";
      ...
      <section className="single-movie-header">
        {singleMovie?.backdrop_path ? (
          <motion.img
            ...
            src={`https://image.tmdb.org/t/p/original/${
              singleMovie.cover ? singleMovie.cover : singleMovie.backdrop_path
            }`}
          />
        ) : (
          <motion.img
        ...
        <section className="header-description">
          <section className="title-section">
            <h3 className="title">
              {singleMovie.title}{" "}
              {singleMovie.release_year.length !== 0
          ...
          {singleMovie &&
          singleMovie.countries &&
          singleMovie.countries.length > 0 ? (
            <section>
        ...
        <section className="additional-info">
          ...
          <h4>
            ...
            {singleMovie.duration ? (
              <span>{singleMovie.duration} mins</span>
            ) : (
              <span>N/A</span>
            )}
          </h4>
          ...
          <h4>
            Language:{" "}
            {singleMovie.original_lang ? (
              <span>{singleMovie.original_lang}</span>
            ) : (
              <span>N/A</span>
            )}
          </h4>
        ...
        >
          ...
          <ul className="cast-preview-grid">
            {castPreview.map((person, index) => (
              <li key={index}>
                <Link
                  onClick={() => dispatch(getCastDetails(person.id))}
