...
const HeaderTwo = ({ toggleMenu, disabledMenu, theme, setThemeMode }) => {
  const ref = useRef();
                ...
                <li key={index}>
                  <Link
                    onClick={() => {
                      if (result.media_type === "movie") {
                        dispatch(getMovie(result.id));
                      }
                      if (result.media_type === "person") {
                        dispatch(getCastDetails(result.id));
                      }
                      // searchResults([]);
                      setQuery("");
                    }}
                  ...
                  >
                    {result.poster_path ? (
                      ...
                      <img alt={`${result.title}`} src={NoImage} />
                    )}
                    <section>
                      <h3>
